package com.knd.front.food.controller;
...
public class FoodRecordController {
    ...
    @Log("I252-维护食物记录")
    @ApiOperation(value = "I252-维护食物记录")
    ...
    public Result saveFood(@RequestBody @Validated VoSaveFoodRecord vo , BindingResult bindingResult) {
        ...
        if (vo.getPostType().equals("1")) {
            //新增
            return iFoodRecordService.add(vo.getUserId(), vo);
        } else {
            //更新
            //数据检查
            ...
            return iFoodRecordService.edit(vo.getUserId(), vo);
        }
    }

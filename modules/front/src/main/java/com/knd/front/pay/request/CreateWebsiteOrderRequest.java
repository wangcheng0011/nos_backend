...
@Data
@ApiModel("创建网站订单请求对象")
public class CreateWebsiteOrderRequest {
...
//    private String userId;
    ...
    @NotNull
    @DecimalMin(value = "0",message = "订单付款金额不能小于0")
    private BigDecimal amount;

    @ApiModelProperty(value = "订单来源")
//    @NotBlank(message = "订单来源不能为空")
    @Pattern(regexp = "^(3)$",message = "订单来源只能是3")
    private String orderSource ="3";

    @Pattern(regexp = "^(1|2|3|4)$",message = "订单类型只能是1-vip购买2-商品(配件)购买3-课程购买4-机器购买")
    ...
    @Pattern(regexp = "^(1|2|3|4)$",message = "支付方式只能是 1支付宝,2微信,3.银联4.现金（线下）")
    private String paymentType;

    @ApiModelProperty(value = "主题描述")
    private String description;

    @ApiModelProperty(value = "平台订单号（支付宝|微信|苹果）")
    @NotBlank(message = "平台订单号（支付宝|微信|苹果）不能为空")

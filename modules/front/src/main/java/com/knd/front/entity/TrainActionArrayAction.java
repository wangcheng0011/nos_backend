...
@TableName("train_action_array_action")
@ApiModel(value="TrainActionArrayAction对象", description="")
public class TrainActionArrayAction extends BaseEntity {

    private static final long serialVersionUID=1L;

    @ApiModelProperty(value = "动作序列训练项Id")
    private String trainActionArrayItemId;
